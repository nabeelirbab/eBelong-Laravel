...
?>
            ...
            <div style="background: #FFF;max-width: 600px; width: 100%; margin: 0 auto; overflow: hidden; color: #919191; font:400 16px/26px 'Open Sans', Arial, Helvetica, sans-serif;">
                ...
                <div style="width: 100%; float: left; padding: 30px 30px 0; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;">
                    ...
                    public static function getEmailFooter()
                    {
                        ...
                        $copyright = !empty($setting) && !empty($setting['copyright']) ? $setting['copyright'] : 'Copyright Ebelong All Rights Reserved';
                        ?>
                        </div>
                    </div>
                </div>
    ...
    <?php
                    ...
                    public static function getSiteTitle()
                    {
                        ...
                        $title = !empty($settings) && !empty($settings[0]['title']) ? $settings[0]['title'] : 'Ebelong';
                        return $title;
                    }
                    ...
                    {
                        $setting = SiteManagement::getMetaValue('email_data');
                        $email = !empty($setting) && !empty($setting[0]['from_email']) ? $setting[0]['from_email'] : 'support@ebelong.com';
                        return $email;
                    }
                    ...
                    {
                        $setting = SiteManagement::getMetaValue('email_data');
                        $email_id = !empty($setting) && !empty($setting[0]['from_email_id']) ? $setting[0]['from_email_id'] : 'support@ebelong.com';
                        return $email_id;
                    }
                    ...
                    public static function getSignature()
                    {
                        ob_start();
                        $setting = SiteManagement::getMetaValue('email_data');
                        $sender_name = !empty($setting) && !empty($setting[0]['sender_name']) ? $setting[0]['sender_name'] : 'Ebelong';
    ...
    ?>
        <div style="width: 100%;display: grid; float: left; padding: 15px 0 0; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;">
            ...
            <br>
            <div style="overflow: hidden; margin-bottom: 15px; padding: 0 0 0 20px; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;">
