...

{
...

    {
        ...
        if (!empty($request)) {
            ...
            $this->project_type = filter_var($request['project_type'], FILTER_SANITIZE_STRING);

            $this->no_of_hours = filter_var($request['no_of_hours'], FILTER_SANITIZE_STRING);
    ...
    public static function getSearchResult(
        ...
        if (!empty($search_languages)) { 
            ...
            $languages = Language::whereIn('slug', $search_languages)->get()->toArray();
