<template>
  <div>
    <div class="trusted_partner">
      <div
        class="trusted_partner__items container d-flex flex-wrap justify-content-between align-items-center"
      >
        <div class="py-2 py-md-4 bannerjob__item text-center">Trusted by:</div>
        <br />
        <div class="py-2 py-md-4">
          <img :src="`${baseUrl}/images/home/trusted_by_1.svg`" />
        </div>
        <div class="py-2 py-md-4">
          <img :src="`${baseUrl}/images/home/trusted_by_2.svg`" />
        </div>
        <div class="py-2 py-md-4">
          <img :src="`${baseUrl}/images/home/trusted_by_3.svg`" />
        </div>
        <div class="py-2 py-md-4">
          <img :src="`${baseUrl}/images/home/trusted_by_4.svg`" />
        </div>
        <div class="py-2 py-md-4">
          <img :src="`${baseUrl}/images/home/trusted_by_5.svg`" />
        </div>
      </div>
    </div>
      ...
      <div class="e-freelancer mt-5 mb-5">
        ...
        <div class="text-center mt-5">
          ...
          <a
            ...
            v-bind:href="'/search-results?type=freelancer'"
            >See all</a
          >
        </div>
      </div>
