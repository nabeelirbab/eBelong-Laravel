...
Vue.component(
  "cources_skills",
  require("./components/CourcesSkillComponent.vue").default
);
Vue.component(
  "agency_skills",
  require("./components/AgencySkillComponent.vue").default
);
Vue.component(
...
Vue.component(
  "job-expiry",
  require("./components/JobExperyComponent.vue").default
);
Vue.component(
  "create-page",
  require("./components/pageBuilder/create.vue").default
);
Vue.component(
  "edit-page",
  require("./components/pageBuilder/edit.vue").default
);
Vue.component(
  "show-page",
  require("./components/pageBuilder/show/index.vue").default
);
Vue.component(
  "second-slider",
  require("./components/pageBuilder/show/sliders/style2.vue").default
);
Vue.component(
  "third-slider",
  require("./components/pageBuilder/show/sliders/style3.vue").default
);
Vue.component(
  "search-theme5-form",
  require("./components/SearchComponent2.vue").default
);
Vue.component(
  "candidate_wishlist",
  require("./components/CandidateWishlist.vue").default
);
Vue.component(
  "candidate_count",
    ...
    methods: {
      ...
      downloadAttachment: function (type, attachment, id) {
        window.location.replace(
          APP_URL + "/get/" + type + "/" + attachment + "/" + id
        );
      },
      changeStatus: function (id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/order/change-status", {
            status: status,
            id: id,
          })
  ...
  const registration = new Vue({
    ...
    mounted: function () {
      ...
      if (searchParams.get("email")) {
        this.$el.querySelector("#user_email").value = searchParams.get("email");
      }
    },
    data: {
      skills: null,
    ...
    methods: {
      ...
      onboardDirectly: function (e) {
        ...
        form_data.append("skills", JSON.stringify(this.skills));
        var self = this;

        axios
          .post(APP_URL + "/register/onboard-user", form_data)
          .then(function (response) {
          ...
          .catch(function (error) {
            ...
            if (error.response.data.errors.termsconditions) {
              self.form_step2.termsconditions_error =
                error.response.data.errors.termsconditions[0];
...
if (document.getElementById("onboard_skill_id")) {
  new Vue({
    el: "#onboard_skill_id",
...
if (document.getElementById("user_profile")) {
  const freelancerProfile = new Vue({
    ...
    mounted: function () {
      ...
      var countvideosLength = jQuery(".social-icons-content").find(
        ".wrap-social-icons"
      ).length;
    ...
    methods: {
      ...
      submitAdminFreelancerProfile: function () {
        var self = this;
        var profile_data = document.getElementById("freelancer_profile");
        let form_data = new FormData(profile_data);
        axios
          .post(APP_URL + "/admin/store-freelancer-profile-settings", form_data)
          .then(function (response) {
            if (response.data.type == "success") {
              self.showInfo(Vue.prototype.trans("lang.saving_profile"));
            } else if (response.data.type == "error") {
      ...
      submitAdminEmployerProfile: function () {
        var self = this;
        var profile_data = document.getElementById("employer_data");
        let form_data = new FormData(profile_data);
        axios
          .post(APP_URL + "/admin/store-employer-profile-settings", form_data)
          .then(function (response) {
            if (response.data.type == "success") {
              self.showInfo(response.data.process);
            } else if (response.data.type == "error") {
      ...
      submitEditorProfile: function () {
        ...
        let form_data = new FormData(profile_data);
        axios
          .post(APP_URL + "/editor/store-profile-settings", form_data)
          .then(function (response) {
            if (response.data.type == "success") {
              self.showInfo(response.data.process);
              setTimeout(function () {
      ...
      addcandidate: function (user) {
        ...
        if (numArray.indexOf(parseInt(user)) === -1) {
          numArray.push(parseInt(user));
          this.$cookies.set("candidateIds", JSON.stringify(numArray));
          console.log("candidateIds arr if ", numArray);
          window.location.replace(APP_URL + "/wishlist");
        }
        // numArray.push(parseInt(user));
        // this.$cookies.set("candidateIds",JSON.stringify(numArray));
...
if (document.getElementById("settings")) {
  ...
  const VueSettings = new Vue({
    ...
    mounted: function () {
      ...
      //Delete Search
      var count_social_length =
        jQuery(".search-content").find(".wrap-search").length;
      count_social_length = count_social_length - 1;
      this.social.count = count_social_length;
    ...
    methods: {
        ...
        axios
          ...
          .then(function (response) {
            if (response.data.enable_theme_color == "true") {
              ...
              self.enable_color_text =
                Vue.prototype.trans("lang.primary_color");
      ...
      submitGeneralHomeSettings: function () {
        let settings_form = document.getElementById(
          "general-home-setting-form"
        );
        let form_data = new FormData(settings_form);
        var self = this;
        axios
          .post(APP_URL + "/admin/store/general-home-settings", form_data)
          .then(function (response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitBankSettings: async function () {
        let banktransfar_settings =
          document.getElementById("bank-transfar-form");
        let data = new FormData(banktransfar_settings);
        var self = this;
        axios
          .post(APP_URL + "/admin/store/banktransfar-settings", data)
          .then(function (response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitOrderSettings: function () {
        ...
        var EmployerEmailContent = tinyMCE
          .get("wt-tinymceemployereditor")
          .getContent();
        form_data.append("employer_hire[email_content]", EmployerEmailContent);
        var self = this;
        axios
          .post(APP_URL + "/admin/store/order-settings", form_data)
          .then(function (response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      submitProjectSettings: function () {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/project-settings", form_data)
          .then(function (response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
      ...
      getProjectSettings: function () {
        let self = this;
        axios
          .post(APP_URL + "/admin/get/project-settings")
          .then(function (response) {
      ...
      submitBankDetail: function () {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/store/bank-detail", form_data)
          .then(function (response) {
            if (response.data.type == "success") {
              self.success_message = response.data.message;
              self.showInfo(response.data.progressing);
...
if (document.getElementById("profile_settings")) {
  const switchButton = new Vue({
    ...
    methods: {
      ...
      changeFeaturedStatus: function (id) {
        this.loading = true;
        var status = document.getElementById(id + "-is_featured").value;
        var self = this;
        axios
          .post(APP_URL + "/admin/update-user-is-featured-status", {
            status: status,
            id: id,
          })
          .then(function (response) {
      ...
      changeCertifiedStatus: function (id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/update-user-is-certified-status", {
            status: status,
            id: id,
          })
          .then(function (response) {
      ...
      changeDisabledStatus: function (id) {
        this.loading = true;
        var status = document.getElementById(id + "-is_disabled").value;
        var self = this;
        axios
          .post(APP_URL + "/admin/update-user-is-disabled-status", {
            status: status,
            id: id,
          })
          .then(function (response) {
      ...
      changeBadge: function (id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/update-user-badge", {
            status: status,
            id: id,
          })
          .then(function (response) {
      ...
      changeAgencyStatus: function (userid, obj) {
        let self = this;
        axios
          .get(APP_URL + "/agency-user-status-change/" + userid)
          .then(function (response) {
            if (response.data.type == "success") {
              self.showMessage(response.data.message);
            }
  ...
  const jobVue = new Vue({
    ...
    methods: {
      ...
      check_auth: function (url) {
        var self = this;
        axios
          .get(APP_URL + "/check-proposal-auth-user")
          .then(function (response) {
      ...
      hireFreelancer: function (id, mode) {
        this.$swal({
          ...
          if (result.value) {
            if (mode == "false") {
              axios
                .post(APP_URL + "/user/generate-order/bacs/" + id + "/job")
                .then(function (response) {
                  if (response.data.type == "success") {
                    window.location.replace(
                      APP_URL +
    ...
    methods: {
      ...
      generateOrder: function (id) {
        if (id) {
          var self = this;
          axios
            .post(APP_URL + "/user/generate-order/bacs/" + id + "/package")
            .then(function (response) {
              if (response.data.type == "success") {
                window.location.replace(
                  APP_URL +
      ...
      submitTransection: function (id) {
        if (!document.getElementById("transection_detail").value)
          return this.showError(
            Vue.prototype.trans("lang.transection_detail_req")
          );
        this.loading = true;
        ...
        var self = this;
        axios
          .post(APP_URL + "/user/submit/transection", data)
          .then(function (response) {
            if (response.data.type == "success") {
  ...
  new Vue({
    ...
    methods: {
      ...
      changePayoutStatus: function (id, projects_ids) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/admin/update-payout-status", {
            status: status,
            id: id,
          ...
          .then(function (response) {
            if (response.data.type == "success") {
              self.showMessage(response.data.message);
              self.loading = false;
            } else if (response.data.type == "IN_PROCESS") {
              var option = document.createElement("option");
              option.text = "In Progress";
              option.value = "in_progress";
              option.selected = "selected";
              var select = document.getElementById(id + "-payout_status");
              select.appendChild(option);
              var form = document.getElementById(
                select.parentNode.parentNode.parentNode.parentNode.id
              );
              form.setAttribute("style", "pointer-events:none;");
              self.showMessage(response.data.message);
              self.loading = false;
            } else {
              self.loading = false;
      ...
      generatePdfPayout: function (year, month) {
        ...
        window.location.replace(
          APP_URL + "/admin/payouts/download/" + year + "/" + month + "/" + ids
        );
      },
    },
  });
...
if (document.getElementById("workdiary")) {
  const vworkdiary = new Vue({
    el: "#workdiary",
    mounted: function () {
      if (document.getElementsByClassName("flash_msg") != null) {
        flashVue.$emit("showFlashMessage");
    ...
    methods: {
      ...
      SubmitWorkDiary: function () {
        ...
        var self = this;
        axios
          .post(APP_URL + "/bill/workdiary/create", form_data)
          .then(function (response) {
            if (response.data.type == "success") {
              self.loading = false;
              self.showInfo(Vue.prototype.trans("lang.add_hours"));
          ...
          .catch(function (error) {
            ...
            if (error.response.data.errors.project_id) {
              self.showError(error.response.data.errors.project_id[0]);
            }
            if (error.response.data.errors.date) {
              self.showError(error.response.data.errors.date[0]);
            }
            if (error.response.data.errors.start_time) {
              self.showError(error.response.data.errors.start_time[0]);
            }
            if (error.response.data.errors.end_time) {
              self.showError(error.response.data.errors.end_time[0]);
            }
            if (error.response.data.errors.description) {
              self.showError(error.response.data.errors.description[0]);
            }
...
if (document.getElementById("agency")) {
  ...
  document.getElementById("show").innerHTML = char + "/200";
  console.log("hi");
  const vagency = new Vue({
    ...
    methods: {
      ...
      countWords: function () {
        var words = document.getElementById("description").value;
        ...
        document.getElementById("show").innerHTML = count + "/200";
        if (count > wordLen) {
          document.getElementById("description").value = document
            ...
            .splice(0, 200)
            .join(" ");
          document.getElementById("show").innerHTML = "200/200";
        }
      },
      submitAgency: function () {
        ...
        try {
          axios
            .post(APP_URL + "profile/settings/save-agency", form_data)
            .then(function (response) {
              ...
              if (response.data.type == "success") {
                ...
                document.addEventListener("iziToast-closing", function (data) {
                  if (data.detail.id == "info_notify") {
                    self.showCompleted(response.data.message);
                    window.location.replace(
                      APP_URL + "/freelancer/courses/posted"
                    );
                  }
                });
              } else {
  ...
  const vservices = new Vue({
    ...
    methods: {
      ...
      sendMessage: function (id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/course/send-message", form)
          .then(function (response) {
            console.log(response);
            if (response.data.type == "success") {
              self.loading = false;
      ...
      sendMessagetoInstructor: function (id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/course/send-message-to-instructor", form)
          .then(function (response) {
            // console.log(response);
            if (response.data.type == "success") {
              self.loading = false;
      ...
      submitCource: function () {
        ...
        var self = this;
        axios
          .post(APP_URL + "/courses/post-course", form_data)
          .then(function (response) {
            if (response.data.type == "success") {
              self.loading = false;
              self.showInfo(response.data.progress);
      ...
      getSettings: function () {
        ...
        if (segment_str == "/freelancer/dashboard/edit-course/" + id) {
          axios
            .post(APP_URL + "/course/get-course-settings", {
              id: id,
            })
            .then(function (response) {
              if (response.data.type == "success") {
      ...
      updateCource: function (id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/service/update-course", form_data)
          .then(function (response) {
            self.loading = false;
            if (response.data.type == "success") {
              self.showInfo(response.data.progress);
      ...
      changeStatus: function (id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/courses/change-status", {
            status: status,
            id: id,
          })
          .then(function (response) {
      ...
      changeCourseStatus: function (id) {
        ...
        var self = this;
        axios
          .post(APP_URL + "/courses/change-course-status", {
            status: status,
            id: id,
          })
          .then(function (response) {
        ...
        if (user_role == "freelancer") {
          this.$swal({
            ...
            if (result.value) {
              ...
              // }
              window.location.replace(
                APP_URL + "/course/" + id + "/generate-order"
              );
            } else {
              this.$swal.close();
            }
                    ...
                    document.addEventListener(
                      ...
                      function (data) {
                        if (data.detail.id == "info_notify") {
                          self.showCompleted(response.data.message);
                          window.location.replace(
                            APP_URL + "/freelancer/courses/bought"
                          );
                        }
                      }
                    );
    ...
    methods: {
      ...
      deleteChecked: function (msg, text) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/article/delete-checked-cats", {
                ids: deleteIDs,
              })
              .then(function (response) {
                if (response.data.type == "success") {
                  ...
                  window.location.replace(
                    APP_URL + "/admin/article/categories"
                  );
                } else {
                  self.showError(response.data.message);
                }
    ...
    methods: {
      ...
      deleteChecked: function (msg, text) {
        ...
        this.$swal({
          ...
          if (result.value) {
            axios
              .post(APP_URL + "/admin/article/delete-checked-article", {
                ids: deleteIDs,
              })
              .then(function (response) {
                if (response.data.type == "success") {
...
if (document.getElementById("invite_people")) {
  var vminvitePeopleList = new Vue({
    el: "#invite_people",
