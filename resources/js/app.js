    ...
    const registration = new Vue({
        ...
        methods: {
            ...
            onboardDirectly:function(e){
                ...
                axios.post(APP_URL + '/register/onboard-user', form_data)
                    .then(function (response) {
    ...
    const freelancerProfile = new Vue({
        ...
        methods: {
			...
			submitAdminFreelancerProfile: function () {
                ...
                var profile_data = document.getElementById('freelancer_profile');
                let form_data = new FormData(profile_data);
                axios.post(APP_URL + '/admin/store-freelancer-profile-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.showInfo(Vue.prototype.trans('lang.saving_profile'));
                        } else if (response.data.type == 'error') {
			...
			submitAdminEmployerProfile: function () {
                ...
                var profile_data = document.getElementById('employer_data');
                let form_data = new FormData(profile_data);
                axios.post(APP_URL + '/admin/store-employer-profile-settings', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.showInfo(response.data.process);
                        } else if (response.data.type == 'error') {
    ...
    const VueSettings = new Vue({
        ...
        methods: {
            ...
            submitBankSettings: async function () {  
                let banktransfar_settings = document.getElementById('bank-transfar-form');
                let data = new FormData(banktransfar_settings);
                var self = this;
                axios.post(APP_URL + '/admin/store/banktransfar-settings', data)
                .then(function (response) {
                    if (response.data.type == 'success') {
                        self.success_message = response.data.message;
                        self.showInfo(response.data.progressing); 
    ...
    const switchButton = new Vue({
        ...
        methods: {
			...
			changeFeaturedStatus: function (id) {
                ...
                var self = this;
                axios.post(APP_URL + '/admin/update-user-is-featured-status', {
                    status: status,
                    id: id,
                })
                .then(function (response) {
            ...
            changeAgencyStatus: function (userid,obj) {
                let self = this; 
                axios.get(APP_URL + '/agency-user-status-change/'+userid)
				.then(function (response) { 
					if (response.data.type == 'success') { 
						self.showMessage(response.data.message);
					} 
            ...
            changePayoutStatus: function (id, projects_ids) {
                ...
                .then(function (response) {
                    if (response.data.type == 'success') {
                        ...
                        var form = document.getElementById(select.parentNode.parentNode.parentNode.parentNode.id);             
    ...
    const vworkdiary = new Vue({
        ...
        methods: {
            ...
            SubmitWorkDiary: function () {
                ...
                form_data.append('description', description);
                var self = this;
                axios.post(APP_URL + '/bill/workdiary/create', form_data)
                    .then(function (response) {
                        if (response.data.type == 'success') {
                            self.loading = false;
                            ...
                            document.addEventListener('iziToast-closing', function (data) {
                                if (data.detail.id == 'info_notify') {
                                    ...
                                    window.location.replace(APP_URL + '/freelancer/bill/'+slug+'/hired/workdiary/'+project_id);
                                }
                            });
                        } else {
                            self.loading = false;
    ...
    const vmcatList = new Vue({
        ...
        mounted: function (){
            setInterval(function () {
                let self = this;
                axios.get(APP_URL + '/admin/login-notification').then(function (response){
                    if (response.data.type == 'success') {
                        ...
                        for(n;n<login_data.length;n++){
                            ...
                            Vue.notify({
                                ...
                                type: 'warning',
                                title: login_data[n].first_name+" "+ login_data[n].last_name+ '<a class="close" href="#" @click="getUpdateRecord"><i class="fa fa-fw fa-close"></i></a>',
                            ...
                            axios.post(APP_URL + '/admin/login-notification-updated',{id:id}).then(function (response){
