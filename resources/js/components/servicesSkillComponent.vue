        ...
        methods: {
            ...
            getSkills(){
               let self = this;
                ...
                console.log(slug)
                axios.post(APP_URL + '/skills/get-service-skills',{
                    slug: slug
                })
            ...
            getUserSkills(){
                ...
                if(edit_url == "edit-service") {
                    var id = segment_array[segment_array.length - 1];
                    console.log("jjj self.id", id)
                    axios.post(APP_URL + '/service/get-stored-service-skills',{
                        id:id
                    })
                    .then(function (response) {
                ...
                // let self = this;
                // axios.get(APP_URL + '/course/get-stored-course-skills')
                // .then(function (response) {
