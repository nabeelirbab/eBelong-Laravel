        ...
        <div class="wt-companysinfo">
            ...
            <div class="wt-userprofile">
                <div class="wt-title">
                    ...
                    <li>
                        <span >
                            <a href="{{{url('agency/'.$agencylogo->slug) }}}">  <img src="{{ asset('uploads/agency_logos/' . $is_member_agency->agency_id.'/'.$agencylogo->agency_logo) }}"style="max-width: 70px; right:190px"> {{{ $agencylogo->agency_name }}}</a>
