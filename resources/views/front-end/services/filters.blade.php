                        ...
                        <div class="wt-checkboxholder wt-verticalscrollbar">
                            @foreach ($locations as $location)
                                ...
                                <span class="wt-checkbox">
                                    ...
                                    <label for="location-{{{ $location->slug }}}"><a href="{{ url('services/'.$location->slug) }}"  > <img src="{{{asset(Helper::getLocationFlag($location->flag))}}}" alt="{{ trans('lang.img') }}" style="width:18px;height:11px"> {{{ $location->title }}}</a></label>
                                </span>
                            @endforeach
                        </div>
                    @endif
