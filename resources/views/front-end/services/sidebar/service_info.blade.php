<div class="wt-userrating wt-userratingvtwo">
    ...
    <div class="wt-rating-info">
       ...
       <div class="wt-ratingcontent">
          ...
          <a href="javascript:;" class="wt-btn" v-on:click.prevent="hireFreelancer('{{{$auth}}}','{{{$service->id}}}', '{{{trans('lang.hire_service_title')}}}', '{{{trans('lang.hire_service_text')}}}', '{{$mode}}')">{{ trans('lang.buy_now') }} </a>
       </div>
    </div>
 </div>