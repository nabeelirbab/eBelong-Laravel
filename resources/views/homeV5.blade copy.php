...
<head>
	...
	<link href="{{ asset('worketic/css/dd.css') }}" rel="stylesheet">
	<link href="{{ asset('worketic/css/app.css') }}" rel="stylesheet">
	<link href="{{ asset('worketic/css/normalize-min.css') }}" rel="stylesheet">
	<link href="{{ asset('worketic/css/scrollbar-min.css') }}" rel="stylesheet">
	...
	<link href="{{ asset('worketic/css/themify-icons.css') }}" rel="stylesheet">
	<link href="{{ asset('worketic/css/jquery-ui-min.css') }}" rel="stylesheet">
	{{-- <!-- <link href="http://amentotech.com/projects/worketic/css/linearicons.css" rel="stylesheet"> --> --}}
	<link href="{{asset('css/linearicons.css') }}" rel="stylesheet">
	<link href="{{ asset('worketic/css/owl.carousel.min.css') }}" rel="stylesheet">
	<link href="{{ asset('worketic/css/main.css') }}" rel="stylesheet">
	<link href="{{ asset('worketic/css/custom.css') }}" rel="stylesheet">
	<link href="{{ asset('worketic/css/responsive.css') }}" rel="stylesheet">
	<link href="{{ asset('worketic/css/color.css') }}" rel="stylesheet">
	<link href="{{ asset('worketic/css/maintwo.css') }}" rel="stylesheet">
	<link href="{{ asset('worketic/css/transitions.css') }}" rel="stylesheet">
 ...
 */
    ...
    /*frelancer slider image align*/
	
	.wt-freelancers-silder .owl-nav {
    position: absolute;
    top: 50%;
	    width: 100%;
	}
.wt-freelancers-silder .owl-nav button {
    position: absolute;
    width: 50px;
    z-index: 9;
    background: transparent;
}.wt-freelancers-silder .owl-nav button.owl-prev {
    left: 0;
}button.owl-next {
    right:35px;
}
.wt-freelancers-silder .owl-nav button span {
    line-height: 40px;
    width: 40px;
    height: 40px;
    font-size: 40px;
...
.wt-freelancers-silder .owl-nav button:focus {
    outline: none;
}
.wt-freelancers-silder .owl-nav button.owl-next {
  left: 79%;
}
	</style>
</head>
			...
			<header id="wt-header" class="wt-header wt-headereleven">
				<div class="wt-navigationarea">
					<div class="container-fluid">
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><strong class="wt-logo wt-logo-header" ><a href="{{{ url('/') }}}"><!--<img src="{{{ asset($logo) }}}" alt="{{{ trans('Logo') }}}" style="height:30px;">--></a>
   <img src="{{ asset('uploads/settings/general/ebelong-logo-header.png') }}" alt="{{{ trans('Logo') }}}" style="width:200px;" >
							</strong>
			...
			<div id="wt-verticalscrollbar" class="wt-verticalscrollbar mCustomScrollbar _mCS_1"><div id="mCSB_1" class="mCustomScrollBox mCS-light mCSB_vertical mCSB_inside" style="max-height: none;" tabindex="0"><div id="mCSB_1_container" class="mCSB_container" style="position:relative; top:0; left:0;" dir="ltr">
									...
									<div class="wt-bannercontent-wrap">
										<div class="container-fluid">
											<div class="row">
												...
												<div class="wt-bannerthree-title"><span style="color: rgb(255, 255, 255);"><h2>Hire Top Talent</h2></span>
													<h2 style="color: rgb(255, 255, 255);"><em style="color: rgb(255, 255, 255);">for most demanding &amp; challenging jobs</em>
                               
                            </h2>
													<div class="wt-description">
														<p>We have done the leg work, hiring is now 1 click away</p>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="owl-stage-outer">
									<div class="owl-stage" style="transform: translate3d(5709px, 0px, 0px); transition: all 0s ease 0s; width: 15224px;">
										<div class="owl-item cloned" style="width: 1903px;">
											<figure class="item"><img src="{{ asset('worketic/uploads/pages/10/1588246878-img-03.jpg') }}" alt="img description"></figure>
										</div>
										<div class="owl-item cloned" style="width: 1903px;">
											<figure class="item"><img src="{{ asset('worketic/uploads/pages/10/1588246878-img-04.jpg') }}" alt="img description"></figure>
										</div>
										<div class="owl-item" style="width: 1903px;">
											<figure class="item"><img src="{{ asset('worketic/uploads/pages/10/1588246877-img-01.jpg') }}" alt="img description"></figure>
										</div>
										<div class="owl-item animated owl-animated-in fadeIn active" style="width: 1903px;">
											<figure class="item"><img src="{{ asset('worketic/uploads/pages/10/1588246878-img-02.jpg') }}" alt="img description"></figure>
										</div>
										<div class="owl-item" style="width: 1903px;">
											<figure class="item"><img src="{{ asset('worketic/uploads/pages/10/1588246878-img-03.jpg') }}" alt="img description"></figure>
										</div>
									...
									<div id="carousel_4iv3b94k0i3" class="owl-carousel owl-theme owl-loaded owl-drag">
										<div class="owl-stage-outer">
											<div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 1507px;">
												...
												<div class="owl-item <?php if($key < 4) { ?> active <?php } ?>" style="width: 346.6px; margin-right: 30px;">
													<div class="wt-freelancer"> 
														<figure class="wt-freelancer-img top_freelance"><img src="{{{ asset(Helper::getImageWithSize('uploads/users/'.$freelancer->id, $freelancer->avater, 'listing')) }}}" alt="image"></figure>
														<div class="wt-freelancer-head">
															...
															<div class="wt-title">
																<h3><?php echo $freelancer->tagline;?></h3></div>
														
															<?php if(!empty($freelancer->skills)) { ?>
															<div class="wt-freelancer-social">
																<ul>
																	<?php foreach ($freelancer->skills as $key1 => $skill){ ?>
																	<li><a href="javascript:void(0)"><?php echo $skill['title']; ?></a></li>
																	<?php } ?>
																</ul>
															</div> 
															<?php }else{ ?>
														...
														<?php if(!empty($freelancer->hourly_rate)) { ?>
																<div class="wt-freelancer-price"><span><i class="fas fa-money-bill-alt"></i> $<?php echo $freelancer->hourly_rate;?> / hr </span></div>
																<?php }else{ ?>
																	<div class="wt-freelancer-price"><span><i class="fas fa-money-bill-alt"></i> - </span></div>
																<?php }?>
													</div>
												</div> 
												<?php // } ?>
				...
				<div class="section-main-wrapper21">
					...
					<section class="null wt-haslayout  wt-main-section wt-bg-holder wt-categories-wrap" style="padding: 160px 0px; margin: 0px;">
						<div class="wt-overlay-1" style="background-image: url(&quot;{{ asset('worketic/uploads/pages/10/1588246878-img-01.png') }}&quot;);"></div>
						<div class="container">
							<div class="row align-items-center">
								<div class="col-12 col-lg-6">
									<div class="wt-categories-holder">
										<div class="wt-sectionheadvtwo">
											<div class="wt-sectiontitlevtwo"><span style="color: rgb(61, 68, 97);">Explore the highly paid</span>
												<h2 style="color: rgb(61, 68, 97);">Job 
                                <em style="color: rgb(144, 19, 254);">Categories  </em></h2></div>
											<div class="wt-description">
												<p>We at eBelong only list highly paid jobs openings for most demanding skilled Professionals </p>
											</div>
											<div class="wt-btnarea"><a href="{{url('search-results?type=job')}}" class="wt-btntwo">Show All</a></div>
										</div>
									</div>
								</div>
								<div class="col-12 col-lg-6">
				...
				<div class="section-main-wrapper32">
					...
					<section class="null wt-haslayout wt-main-section wt-section-bg wt-latestjobs-wrap" style="padding: 80px 0px; margin: 108px 0px 0px; background: rgb(245, 247, 250);">
						...
						<div class="wt-overlay-2" style="background-image: url(&quot;{{ asset('worketic/uploads/pages/10/1588246877-img-02.png') }}&quot;);"></div>
						<div class="container">
												...
												<div class="wt-latestjob-holder">
													<div class="wt-latestjob-head">
														<figure class="wt-latestjob-logo">
															<img src="{{ asset('worketic/uploads/users/2/ebelongicon.png') }}" alt="img description">
														</figure>
														<div class="wt-latestjob-title">
															<div class="wt-latestjob-tag"><a href="{{url('profile/'.$job['employee_slug'])}}"> <?php echo $job['employeers_name'];?>  </a></div>
															<h4><a href="{{{url('job/'.$job['slug'])}}}"><?php echo $job['title'];?></a></h4> <span><?php echo $job['location_name'];?></span>
														</div>
														<div class="wt-latestjob-right"><span>Rate</span>
															<h4><sup>$</sup><?php echo $job['price']; ?><?php echo $job['project_type'] == "hourly"? ' /Hour': ''; ?></h4> <span><?php echo Helper::getJobDurationList($job['duration']); ?></span></div>
													</div>
...
<div class="wt-description"> 
	<div>	
	<img src="{{ asset('images/why-ebelong.png') }}" >
	<div class="wt-btnarea" style="margin-top:20px"><a href="{{{ route('register') }}}" class="wt-btntwo" style="float:right">Register Now!</a></div>
    </div>
<!-- <table>
<tbody>
<tr>
...
<p>&nbsp;</p>
				...
				<div class="section-main-wrapper54">
					...
					<section class="null wt-main-section wt-section-bg wt-freelancers-wrap" style="padding: 80px 0px; margin: 108px 0px 0px; background: rgb(245, 247, 250);">
						...
						<div class="wt-overlay-4" style="background-image: url(&quot;{{ asset('worketic/uploads/pages/10/1588246876-img-03') }}.png&quot;);"></div>
						<div class="container">
							<div class="row justify-content-center">
								<div class="col-12 col-lg-8">
									<div class="wt-sectionheadvthree wt-textcenter">
				...
				<div class="row">
					<div class="col-12 col-sm-12 col-md-6 col-lg-6">
						<div class="wt-footerlogohold"> <strong class="wt-logo"><a href="{{{ url('/') }}}"><!--<img src="{{{ asset($logo) }}}" alt="company logo here">-->
							<img src="{{ asset('uploads/settings/general/ebelong-logo-footer.png') }}" alt="company logo here" style="width:250px;">
						</a></strong>
							<div class="wt-description">
	...
	<script src="{{ asset('worketic/js/scrollbar.min.js') }}"></script>
	<script src="{{ asset('worketic/js/particles.min.js') }}"></script>
	<script src="{{ asset('worketic/js/jquery-ui-min.js') }}"></script>
	<script src="{{ asset('worketic/js/prettyPhoto-min.js') }}"></script>
	<script src="{{ asset('worketic/js/owl.carousel.min.js') }}"></script>
	<script src="{{ asset('worketic/js/tilt.jquery.js') }}"></script>
...
<script>
      ...
      $(document).ready(function() {
		function loadMoreJobs(){
			// .wt-latestjobs .wt-btnarea .wt-btntwo
			var jobsList = $(".wt-latestjobs > ul > li.deactivate");
			//console.log(jobsList)
			if (jobsList.length > 4){
				for(var i = 0 ; i < 4; i++){
					$(jobsList[i]).removeClass('deactivate')
				}
			} else {
				jobsList.removeClass('deactivate')	
				$(".wt-latestjobs > div.wt-btnarea > a.wt-btntwo").css("display", "none")
			}
		}
		
		loadMoreJobs();
		$(".wt-latestjobs > div.wt-btnarea > a.wt-btntwo").on("click", () => loadMoreJobs())
		...
		$('#wt-freelancers-silder').owlCarousel({
			items: 4,
			loop: true,
			margin: 15,
			nav: true,
