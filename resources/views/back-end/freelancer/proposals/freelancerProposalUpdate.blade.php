                ...
                <div class="row justify-content-md-center">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 push-lg-2" id="jobs">
                            ...
                            <div class="wt-proposalhead">
                                ...
                                <ul class="wt-userlisting-breadcrumb wt-userlisting-breadcrumbvtwo">
                                    ...
                                    @if (!empty($job->location->title))
                                        <li><span><img src="{{{asset(Helper::getLocationFlag($job->location->flag))}}}" alt="{{ trans('lang.img') }}" style="width:18px;height:11px;"> {{{ $job->location->title }}}</span></li>
                                    @endif
                        ...
                        <div class="wt-proposalamount-holder">
                            ...
                            {!! Form::open(['url' => url('proposal/update-proposal'), 'class' =>'wt-haslayout', 'id' => 'update-propsal'  ]) !!}
                            {!! Form::input('hidden', 'job_id', e($job->id))!!}
                            {!! Form::input('hidden', 'id', e($proposal->id))!!}
                            <div class="wt-proposalamount accordion">
                                    <div class="form-group">
                                        <span>( <i>{{ !empty($symbol) ? $symbol['symbol'] : '$' }}</i> )</span>
                                        {!! Form::input('number', 'amount',e($proposal->amount), null, ['class' => 'form-control', 'min' => 1, 'placeholder' => trans('lang.ph_proposal_amount'), 'v-model'=>'proposal.amount', 'v-on:keyup' => "calculate_amount('$commision')" ])!!}
                                    ...
                                    @else  
											...
											<ul class="wt-totalamount collapse show" id="collapseOne" aria-labelledby="headingOne">
												<li v-cloak>
                                                    <h3>( <i>{{ !empty($symbol) ? $symbol['symbol'] : '$' }}</i> ) <em>@{{this.proposal.total}} 
                                    ...
                                    <fieldset>
                                        <div class="form-group">
                                            <span class="wt-select">
                                                {!! Form::select('completion_time',$job_completion_time , e($job_completion_time[$proposal->completion_time]), array('v-model'=>'proposal.completion_time', 'placeholder' => trans('lang.ph_job_completion_time') )) !!}
                                            </span>
                                        </div>
                                        <div class="form-group">
                                            {!! Form::textarea('description',e($proposal->content) ,null, ['class' => 'form-control', 'id' => '', 'placeholder' =>  trans('lang.ph_cover_letter') , 'v-model'=>'proposal.description']) !!}
                                        </div>
                                    </fieldset>
