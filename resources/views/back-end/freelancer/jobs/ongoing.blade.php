                                    ...
                                    <div class="wt-userlistingcontent">
                                        ...
                                        <div class="wt-rightarea">
                                            ...
                                            <!--<div class="wt-btnarea" style="margin-right:15px;">
                                                <a href="{{{ url('freelancer/bill/'.$job->slug.'/'.$job->status.'/workdiary/' .$job->id) }}}" class="wt-btn">View Bill</a>
                                            </div> -->
                                        	<div class="wt-btnarea" style="margin-right:15px;">
                                                <!-- <a href="/bill/workdiary" class="wt-btn">Add Bill</a> -->
                                                <a href="{{{ url('freelancer/bill/'.$job->slug.'/'.$job->status.'/workdiary/' .$job->id) }}}" class="wt-btn">Add Bill</a>
                                            </div>
                                           @endif
