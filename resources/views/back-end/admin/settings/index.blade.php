                ...
                <div class="wt-dashboardbox wt-dashboardtabsholder wt-accountsettingholder">
                    ...
                    <div class="wt-tabscontent tab-content">
                        ...
                        <div class="wt-securityhold tab-pane la-payment-setting" id="wt-payment">
                            ...
                            @endif
                            @if (file_exists(resource_path('views/back-end/admin/settings/payment/banktransfar-settings.blade.php')))
                                 @include('back-end.admin.settings.payment.banktransfar-settings')
                            @endif 
                        </div>
