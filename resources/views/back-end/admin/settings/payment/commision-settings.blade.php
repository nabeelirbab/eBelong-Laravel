{!! Form::open(['url' => '', 'class' =>'wt-formtheme wt-userform', 'id' =>'comission-form', '@submit.prevent'=>'submitCommisionSettings'])!!}
    ...
    <div class="wt-location wt-tabsinfo">
        <div class="wt-tabscontenttitle">
            <h2>Freelancer {{{ trans('lang.commission_settings') }}}</h2>
        </div>
        <div class="wt-settingscontent">
    ...
    <div class="wt-location wt-tabsinfo">
        <div class="wt-tabscontenttitle">
            <h2>Employer {{{ trans('lang.commission_settings') }}}</h2>
        </div>
        <div class="wt-settingscontent">
            <div class="wt-description">
                <p>{{ trans('lang.set_comm_project') }}</p>
            ...
            <div class="wt-formtheme wt-userform">
                <div class="form-group">
                    {!! Form::number('payment[0][emp_commision]', $emp_commision, array('class' => 'form-control', 'placeholder' => '0')) !!}
                </div>
            </div>
        </div>
    </div>
