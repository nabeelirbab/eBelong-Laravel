											...
											<td data-th="Service Title">
												<span class="bt-content">
													<div class="wt-service-tabel">
														@if (!empty($course->seller->count() > 0 && $attachment))
											...
											<td data-th="Action">
												<span class="bt-content">
													<div class="wt-actionbtn">
														...
														<a href="{{{url('freelancer/course/'.$order->id.'/'.$order->status)}}}" class="wt-addinfo wt-skillsaddinfo">
																...
																<div class="d-block text-center">
																	{!! Form::open(['url' => '', 'class' =>'wt-formtheme', 'id' => 'submit_refund_'.$order->id,  '@submit.prevent'=>'submitRefund("'.$order->id.'")']) !!}
																		<fieldset>
																			...
																			<input type="hidden" value="{{$course->price}}" id="refundable-amount-{{$order->id}}">
