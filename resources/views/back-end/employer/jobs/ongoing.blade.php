                                ...
                                <div class="wt-managejobcontent wt-verticalscrollbar mCustomScrollbar _mCS_1">
                                    @foreach ($ongoing_jobs as $job)
                                        @php
                                            ...
                                            $bill_status = \App\WorkDiary::where('project_id',$accepted_proposal->job_id)->first();
                                        ...
                                        <div class="wt-userlistinghold wt-featured wt-userlistingvtwo">
                                            ...
                                            <div class="wt-userlistingcontent">
                                                ...
                                                <div class="wt-rightarea">
                                                    ...
                                                    <div class="wt-btnarea" style="margin-right:20px;">
                                                        <a href="{{{ url('employer/bill/'.$job->slug.'/'.$job->status.'/workdiary/' . $job->id ) }}}" class="wt-btn">View Bill</a>
                                                    </div>
