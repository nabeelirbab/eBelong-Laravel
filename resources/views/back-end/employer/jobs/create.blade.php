                                ...
                                <div class="wt-formtheme wt-userform wt-userformvtwo la-job-details-form">
                                    <fieldset>
                                        <div class="form-group">
                                            <input type="text" name="title" class="form-control" placeholder="{{ trans('lang.job_title') }}" id="title" v-model="title">
                                        </div>
                                        ...
                                        <select id= "proj-type" name="project_type" >
                                            ...
                                            <div class="form-group form-group-half wt-formwithlabel job-cost-input">
                                                <input id="hours" type="text" name="no_of_hours" value="" placeholder ="ADD NUMBER OF HOURS PER WEEK" disabled style="background-color:#ddd; color: #999">
                                            </div>
                                        ...
                                        <input id="proj-cost" placeholder="Project cost" name="project_cost" type="text" style="color: #999">
                                        </div>
    ...
    <script type="text/javascript">
        function generateCompletion(){
            ...
            tinymce.init({
              ...
              var title = $('#title').val();
             $.ajax({
                url: '{{url("generate-completion")}}/?cmd=write job description for '+title,
                type: 'GET',
                dataType: 'json',
