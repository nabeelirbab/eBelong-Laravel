                        ...
                        <thead>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ !empty($symbol['symbol']) ? $symbol['symbol'] : '$' }} {{{$proposal->amount}}} per hour </td>
                                </tr>
                                 <tr>
                                    <td>No of Hours Per Week </td>
                                     <td>{{{$job->no_of_hours }}} hrs/week </td>
                                </tr>
                                 <tr>
                                    <td>Commission</td>
                                     <td>{{{$commision_amount}}} % </td>
                                </tr>
                                <tr>
                                    <td>{{ trans('lang.freelancer') }}</td>
                                    <td>{{{ $freelancer_name }}}</td>
                                ...
                                <tr>
                                    <td>{{ trans('lang.total') }}<br>
                                        <span style = "font-size: 14px;">Based on your estimated {{{$job->no_of_hours }}} hours, your total is ${{{ $total_amount }}} ( ${{{ $hourly_project_amount_per_week}}} + ${{{ $hourly_project_amount_per_week *  ( $commision_amount / 100) }}}   ). We will credit you once freelancer post the actual hours.</span> </td>
                                    <td>{{ !empty($symbol['symbol']) ? $symbol['symbol'] : '$' }} {{{ $total_amount }}} </td>
                                </tr>
                        ...
                        <form class="wt-formtheme wt-form-paycard" method="POST" id="stripe-payment-form" role="form" action="" @submit.prevent='submitStripeFrom'>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group wt-btnarea">
                                    <input type="submit" name="button" class="wt-btn" value="Pay {{ !empty($symbol['symbol']) ? $symbol['symbol'] : '$' }}{{$total_amount}}">
                                </div>
                            </fieldset>
                        </form>
                    </b-modal>
