                    ...
                    <div class="sj-title">
                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                <td>Total No of Hours Billed This Week </td>
                                     <td>{{{ $total_hours }}}  hrs/week </td>
                                </tr>
                                 <tr>
                                    <td>Commission</td>
                                ...
                                <tr>
                                    <td>{{ trans('lang.total') }}<br>
                                         ...
                                         @php   $amount =   $total_hours * $proposal->amount;
                                                $comm_amount = $amount * ( $commision_amount / 100 ) ;
                                                $total_amount = $amount + $comm_amount;
                                                $amount = round($amount);
                                                session()->put(['product_price' => e($amount)]);
