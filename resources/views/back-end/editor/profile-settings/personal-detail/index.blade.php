                ...
                <div class="wt-dashboardbox wt-dashboardtabsholder">
                    <div class="wt-dashboardtabs">
                        <ul class="wt-tabstitle nav navbar-nav">
                           ...
                           <a class="{{{ \Request::route()->getName()==='editorProfile'? 'active': '' }}}" href="{{{ url(route('editorProfile')) }}}">{{{ 'Editor Details' }}}</a>
                    ...
                    <div class="wt-tabscontent tab-content">
                        ...
                        <div class="wt-personalskillshold tab-pane active show">
                            {!! Form::open(['url' => '', 'class' =>'wt-userform', 'id' => 'admin_data', '@submit.prevent' => 'submitEditorProfile']) !!}
                                ...
                                <div class="wt-profilephoto wt-tabsinfo">
                                    @if (file_exists(resource_path('views/extend/back-end/editor/profile-settings/personal-detail/profile_photo.blade.php'))) 
                                        @include('extend.back-end.editor.profile-settings.personal-detail.profile_photo')
                                    @else 
                                        @include('back-end.editor.profile-settings.personal-detail.profile_photo')
                                    @endif
                                </div>
                                <div class="wt-bannerphoto wt-tabsinfo">
                                    @if (file_exists(resource_path('views/extend/back-end/editor/profile-settings/personal-detail/profile_banner.blade.php'))) 
                                        @include('extend.back-end.editor.profile-settings.personal-detail.profile_banner')
                                    @else 
                                        @include('back-end.editor.profile-settings.personal-detail.profile_banner')
                                    @endif
                                </div>
