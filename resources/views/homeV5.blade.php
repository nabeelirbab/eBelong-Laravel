...
<body class="wt-login lang-en ltr ">
    ...
    @endif
			...
			<div class="section-main-wrapper10">
				...
				<div data-component="Slider" data-vue='<?php echo json_encode($freelancers);?>' id="e-freelancer">

				</div>
				<div data-component="BannerJob" data-vue='{}'  id="e-banner-job" >
					
				</div>
				<div data-component="PostSkill" data-vue='<?php echo json_encode(array('categories'=> $categories,'skills'=>$all_skills)) ?>' id="e-postskill">

				</div>
				@auth
				<div data-component="PostJob" data-vue='<?php echo json_encode($user);?>'  id="e-postjob">
				</div>

				@endauth
				@guest
				<div data-component="PostJob" data-vue='{}'  id="e-postjob">
				</div>
